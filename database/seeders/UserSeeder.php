...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $saker=User::create(['name'=>"Saker",'email'=>"saker@gmail.com",'password'=>Hash::make("adminXDXD"),'location'=>"Murcia",'profile_photo_path'=>'img/profileDefault.png','banner_photo_path'=>'img/bannerDefault.png', 'about_you'=>"Illo keloke"]);
